...
class KiscCli_resource_stop(KiscCli_kisc):
    """
    KiSC command-line utility - (Sub)command 'resource stop'
    """
    ...
    def execute(self, _sCommand=None, _lArguments=None):
        ...
        try:
            ...
            if self._oArguments.bootstrap and not self._oArguments.force:
                raise RuntimeError('Can not stop bootstrap (host startup) resource without \'--force\' flag')
