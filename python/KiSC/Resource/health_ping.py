...
class KiscResource_health_ping(KiscResource):
    """
    (IPv4) Ping health check

    Configuration parameters are:
     - [REQUIRED] address (STRING; comma-separated, dotted decimal IPv4):
       IPv4 network address(es) to ping
     ...
     - [OPTIONAL] interface (STRING):
       interface or IPv4 network address to send the ping packet(s) from
